...
<!-- End mainmenu area -->
    ...
    <!-- Tenho que consertar isto depois -->
    ...
    <div class="product-widget-area">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            ...
                            <h2><a href="single-product.html">Samsung Galaxy Z Flip</a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        <h2 class="product-wid-title">Produtos Novos</h2>
                        <a href="#" class="wid-view-more">Ver todos</a>
                        <div class="single-wid-product">
                            <a href="single-product.html"><img src="assets/web/img/product-thumb-3.jpg" alt="" class="product-thumb"></a>
                            <h2><a href="single-product.html">Notebook Asus</a></h2>
