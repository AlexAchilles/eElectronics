...
<!-- End mainmenu area -->
                            ...
                            <div class="col-sm-6">
                                <div class="product-images">
                                    ...
                                    <div class="product-gallery">
                                        <img src="assets/web/img/product-thumb-1.jpg" alt="">
                                        <img src="assets/web/img/product-thumb-2.jpg" alt="">
                                        <img src="assets/web/img/product-thumb-3.jpg" alt="">
                                        <img src="assets/web/img/product-thumb-4.jpg" alt="">
                                    </div>
                                </div>
                            </div>
    ...
    <script src="j<?=url("assets/web/js/jquery.sticky.js"); ?>"></script>
